package com.dp.project.offlineupidemo.crypto;
...
public class HybridCryptoService {
    ...
    public String encrypt(PaymentInstruction instruction, PublicKey serverPublicKey) throws Exception {
        ...
        ByteBuffer buff = ByteBuffer.allocate(encryptedAesKey.length + iv.length + aesCipherText.length);
        buff.put(encryptedAesKey);
        buff.put(iv);
        buff.put(aesCipherText);
    ...
    public PaymentInstruction decrypt(String base64CipherText) throws Exception{
        ...
        SecretKey aesKey = new SecretKeySpec(aesKeyBytes, "AES"); // turning the raw AES key bytes back into a Java SecretKey object
